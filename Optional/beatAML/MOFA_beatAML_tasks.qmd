...
### LF1 values versus FLT3.ITD （FLT3 Internal Tandem Duplication)
```{r}
plot_factor(MOFAobject, 
  factors = 1, 
  color_by = "FLT3.ITD",
...
### LF1 values versus RUNX1 mutation
```{r}
plot_factor(MOFAobject, 
  factors = 1, 
  color_by = "RUNX1",
...
### Explore the biological meaning behind factor 2
...
#### Weight of genomic features on LF2 (just another way of visualisation)
```{r}
plot_top_weights(MOFAobject,
 view = "Mutations",
 factor = 2,
...
### LF2 values versus DNMT3A mutations
```{r}
plot_factor(MOFAobject, 
  factors = 2, 
  color_by = "DNMT3A",
...
### LF2 values versus NPM1 mutations
```{r}
plot_factor(MOFAobject, 
  factors = 2, 
  color_by = "NPM1",
